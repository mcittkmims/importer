...
import com.internship.importer.infrastructure.export.PartitionDataExporter;
...
public class TaskFactory {
        ...
        public DataExportTask createExportTask(
                        ...
                        javax.sql.DataSource dataSource) {
                JdbcTemplate jdbcTemplate = new JdbcTemplate(dataSource);
                StagingRepository stagingRepository = new StagingRepository(jdbcTemplate, config.getTable());
                ...
                DataExporter exporter = new PartitionDataExporter(
                                stagingRepository,
                                config.getExportUrl(),
